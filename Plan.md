...
- [Сценарий 12. Проверяем отправку анкеты с данными в неверном формате в поле "Год"](#title18)
- [Сценарий 13. Проверяем отправку анкеты с данными в неверном формате в поле "CVC/CVV"](#title19)
- [Сценарий 14. Проверяем отправку анкеты с пустыми полями](#title20)
- [Сценарий 15. Проверяем отправку анкеты с незаполненным полем "Номер карты"](#title21)
- [Сценарий 16. Проверяем отправку анкеты с незаполненным полем "Месяц"](#title22)
- [Сценарий 17. Проверяем отправку анкеты с незаполненным полем "Год"](#title23)
- [Сценарий 18. Проверяем отправку анкеты с незаполненным полем "Владелец"](#title24)
- [Сценарий 19. Проверяем отправку анкеты с незаполненным полем "CVC/CVV"](#title25)
